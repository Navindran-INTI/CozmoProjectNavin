...
def handle_cliff(robot: cozmo.robot.Robot):
    ...
    if robot.is_cliff_detected:
        ...
        center_cliffs, _ = process_camera_image(latest_image_center) if latest_image_center else ([], [])
        ...
        _, left_safe = process_camera_image(latest_image_left) if latest_image_left else ([], [])
        ...
        _, right_safe = process_camera_image(latest_image_right) if latest_image_right else ([], [])
